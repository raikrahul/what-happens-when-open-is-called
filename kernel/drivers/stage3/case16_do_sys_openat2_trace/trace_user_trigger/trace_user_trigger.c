...
static int __init trace_user_trigger_init(void)
{
    ...
    pr_info("[trace_user_trigger] loaded target_comm=%s user=kernel/user/stage3/case16_do_sys_openat2_trace/user_trigger.c\n",
...
MODULE_DESCRIPTION("Dedicated Stage3 trace driver for kernel/user/stage3/case16_do_sys_openat2_trace/user_trigger.c");

...
static int __init trace_case6_symlink_loop_init(void)
{
    ...
    pr_info("[trace_case6_symlink_loop] loaded target_comm=%s user=kernel/user/stage3/case1/case6_symlink_loop.c\n",
...
MODULE_DESCRIPTION("Dedicated Stage3 trace driver for kernel/user/stage3/case1/case6_symlink_loop.c");

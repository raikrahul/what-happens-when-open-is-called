...
static int __init trace_case7_symlink_fast_init(void)
{
    ...
    pr_info("[trace_case7_symlink_fast] loaded target_comm=%s user=kernel/user/stage3/case1/case7_symlink_fast.c\n",
...
MODULE_DESCRIPTION("Dedicated Stage3 trace driver for kernel/user/stage3/case1/case7_symlink_fast.c");

...
static char target_comm[TASK_COMM_LEN] = "case15_intensity";
...
{ int rc=register_kprobe(&kp_filp); if (rc) return rc; rc=register_kretprobe(&kr_filp); if (rc) { unregister_kprobe(&kp_filp); return rc; } pr_info("[case15_addon] loaded\n"); return 0; }
static void __exit exit_mod(void)
{ unregister_kretprobe(&kr_filp); unregister_kprobe(&kp_filp); pr_info("[case15_addon] unloaded\n"); }

...
- 16. `kernel/user/stage3/case11_bulk_rename/user_bulk_rename.c` -> `pass_probe_hits` | filp=110/110 dalloc=100/100 | report `kernel/user/stage3/case11_bulk_rename/reports/user_bulk_rename_trace_report.md`
...
- 41. `kernel/user/stage3/multi_path_open.c` -> `pass_probe_hits` | filp=9/9 dalloc=0/0 | report `kernel/user/stage3/stage3/reports/multi_path_open_trace_report.md`

...
## Commands
```bash
make kernel/drivers/stage3/case11_bulk_rename/trace_user_bulk_rename/trace_user_bulk_rename.ko
# build userspace binary target as needed
sudo insmod trace_user_bulk_rename.ko target_comm="user_bulk_renam"

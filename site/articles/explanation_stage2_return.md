...
Chains and diagrams (side by side)

| Chains (real data, in order) | Diagrams |
| --- | --- |
...
structure expected of a research textbook. Each section is followed by direct evidence and a
...
Kernel evidence: do_filp_open entry pointer = 0xffff8bd54c33e020 | /tmp/t_e.txt d_lookup entry: hash
...
Kernel evidence: do_filp_open entry pointer = 0xffff8bd54c33e020 | /tmp/t_m.txt d_lookup entry: hash
...
Kernel evidence: do_filp_open entry pointer = 0xffff8bd54c33e020 | l_m.txt d_lookup entry: hash
...
Kernel evidence: do_filp_open entry pointer = 0xffff8bd54c33e020 | /mnt/loopfs/a.txt d_lookup entry:
...
Kernel evidence: d_delete entry: 0xffff8bd5628ba9f8 | l_e.txt d_delete entry: 0xffff8bd54eaa09f8 |
...
Kernel evidence: do_filp_open entry pointer = 0xffff8bd54c33e020 | /proc/sys/vm/drop_caches
...
Kernel evidence: do_filp_open entry pointer = 0xffff8bd54c33e020 | l_e.txt __d_lookup_rcu entry:
...
Kernel evidence: do_filp_open entry pointer = 0xffff8bd553aca020 |

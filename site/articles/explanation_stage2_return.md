...
Probe output (trace_do_filp_open.c):
[O] IN from open_entry: do_filp_open entry pointer = 0xffff8bd54c33e020 | /proc/sys/vm/drop_caches
[O] OUT from open_ret: do_filp_open return pointer = 0xffff8bd6fce05db8 | drop_caches
...
d_lookup entry from lookup_entry: hash 1830572521 length 7 name t_e.txt
[A] SRC from alloc_entry: __d_alloc entry pointer = 0xffff8bd54c33e025
[A] DST from alloc_ret: __d_alloc return pointer = 0xffff8bd54eaa0338
__d_add entry from d_add_entry: 0xffff8bd54eaa0338 | t_e.txt
[O] OUT from open_ret: do_filp_open return pointer = 0xffff8bd54eaa0338 | t_e.txt
...
Probe output (trace_do_filp_open.c):
[O] IN from open_entry: do_filp_open entry pointer = 0xffff8bd54c33e020 | l_e.txt
__d_lookup_rcu entry from lookup_rcu_entry: hash 440978933 length 7 name l_e.txt
[O] OUT from open_ret: do_filp_open return pointer = 0xffff8bd5450e8278 | l_e.txt
...
Probe output (trace_do_filp_open.c):
[O] IN from open_entry: do_filp_open entry pointer = 0xffff8bd553aca020 | test_file_very_long_name_to_force_external_allocation_1770412974
...
d_lookup return from lookup_ret: NULL
[A] SRC from alloc_entry: __d_alloc entry pointer = 0xffff8bd553aca020
[A] DST from alloc_ret: __d_alloc return pointer = 0xffff8bd69ca2a978
__d_add entry from d_add_entry: 0xffff8bd69ca2a978 | test_file_very_long_name_to_force_external_allocation_1770412974
[O] OUT from open_ret: do_filp_open return pointer = 0xffff8bd69ca2a978 | test_file_very_long_name_to_force_external_allocation_1770412974
